        ...
        <div class="box-header">
          ...
          <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <label >
                <input name="radio" type="radio" id="inlineradio1" value="option1" onchange="determinar();">
                  Option 1 </label>
                  <label >
                    <input name="radio" type="radio" id="inlineradio2" value="option2" onchange="determinar();">
                    Option 2 </label>
                    <label >
                      <input name="radio" type="radio" id="inlineradio3" value="option3" onchange="determinar();">
                      Option 3 </label>
                    </div>
                  </div>
