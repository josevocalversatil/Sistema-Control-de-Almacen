...
@section ('contenido')
     ...
     <div class="row">
     	...
     	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            {!! Form::open(array('url'=>'almacen/memo','method'=>'POST','autocomplete'=>'off'))!!}
            {{Form::token()}}
          ...
          <div class="row">
               ...
               <div class="form-group">
                <label for="folio_memo">Folio Memo</label>
                <input type="text" name="folio_memo" required value="{{old('folio_memo')}}"  class="form-control" placeholder="Folio Memorandum...">
            </div>
          </div>

            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
               <div class="form-group">
                <label for="numero_memo">Numero de Memorandum</label>
                <input type="text" name="numero_memo" required value="{{old('numero_memo')}}"  class="form-control" placeholder="Numero Memorandum">
            </div>
          </div>
                ...
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                  ...
                  <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="punidad_medida" id="punidad_medida" class="form-control" placeholder="P. Medida"> 
                    </div>
                </div>
...
function agregar()
{
    ...
    if (idarticulo!="" && cantidad!="" && cantidad>0 && unidad_medida!="") 
    {
       

        var fila='<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-warning" onclick="eliminar('+cont+');">X</button></td><td><input type="hidden" name="idarticulo[]" value="'+idarticulo+'">'+articulo+'</td><td><input type="number" name="cantidad[]" value="'+cantidad+'"></td><td><input type="text" name="unidad_medida[]" value="'+unidad_medida+'"></td></tr>';
        cont++;
        limpiar();
