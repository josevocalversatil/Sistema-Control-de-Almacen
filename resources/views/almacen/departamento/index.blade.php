                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3>Listado de Departamentos <a href="departamento/create"><button class="btn btn-success">Nuevo</button></a> Generar PDF <a href="#"><button class="btn btn-danger">PDF</button></a></h3>
